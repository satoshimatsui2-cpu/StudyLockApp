...
import com.stulab.studylockapp.databinding.LayoutJourneyHeaderBinding
import com.stulab.studylockapp.ui.components.MasteryProgressGauge
...
object JourneyHeaderBinder {
    fun bind(binding: LayoutJourneyHeaderBinding, model: JourneyHeaderUiModel) {
        ...
        binding.textGoalNewHeader.text = model.newCountText
        binding.textGoalReviewHeader.text = model.reviewCountText
        binding.textGoalReviewTotalHeader.text = model.reviewTotalCountText
    }
}
